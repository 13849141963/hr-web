...
public class CommonDictUtils {
    ...
    public static String[] getRemoveDuplicateCustIds() throws Exception {
        List<CustomerVo> removeDuplicateCustomer = getRemoveDuplicateCustomer();
        String[] custIds  = new String[removeDuplicateCustomer.size()];
        for (int i = 0; i < removeDuplicateCustomer.size(); i++) {
            String custId = removeDuplicateCustomer.get(i).getCustId();
            custIds[i] = custId;
        }
        return custIds;
    }
