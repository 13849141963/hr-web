...
public class FilesDownloadValidateController {
    ...
    @RequestMapping(value = "/entryOnline/validatebatchPrintJobNewIns")
    @ResponseBody
    public R validateDownloadPrintJobNewIns(HttpServletResponse response, @RequestParam(value = "empTaskIds", required = false) Long[] empTaskIds) throws Exception {
        ...
        return getRForValidateFilesDate(method,map);
    }
